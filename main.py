"""Describe choice of a character, them actions and training process."""
...
def attack(char_name: str, char_class: str) -> str:
    """Describe attack of a character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Describe defence of a character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Describe special abilities of a character."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Describe training process of a character."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Describe choice of a character."""
    approve_choice: str = ''
    char_class: str = ''
